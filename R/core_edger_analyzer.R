...
#' MA plot from the data in lrt with title ma_figure_title and saves it in 
#' a pdf and png under the folder figure_dir
#' 
#' @param lrt lrt A dataframe of the edgeR data to plot, typically generated by `perform_edger`
