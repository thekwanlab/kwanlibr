...
#' 
#' @param lrt lrt A dataframe of the edgeR data to plot, typically generated by 
#' `perform_edger`
...
#' @param with_label Boolean value, if True, label each individual point by 
#' individual labels, false shows no label. Default is set to FALSE
#' @param with_legend Boolean value, if True, draw the legend on the PCA, if false, 
