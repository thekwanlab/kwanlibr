...
#' @param batchCol (optional) to enable batch correction, pass a column name that refers to the batch of the sample. If NULL, no batch correction
#' @param filePrefix prefix to add to filenames (e.g. if they are in a different directory). If NULL, search the current working directory
#' @param gtf a dataframe of the reference genome, generated by `kwanlibr::get_gtf`
#' @param saveName filename to save edger tables under. Saves top 5k genes and all genes. If NULL, do not save tables.
...
#' @param lrt a dataframe of the egdger data to plot, typically generated by `perform_edger`
...
#' @param fdr false discovery rate threshold. genes > fdr are colored Default is 0.01
#' @param xdiff x-axis ceiling in both directions, For example, xdiff=5 sets the x axis to -5 to 5. Default is 5
#' @param ymax y-axis ceiling. Default is 40
